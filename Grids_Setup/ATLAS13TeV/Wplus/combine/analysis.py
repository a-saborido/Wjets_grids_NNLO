...
if __name__ == "__main__":
    ...
    HEP: Dict[str, Tuple[pd.Series, pd.Series, List[pd.Series]]] = {
        "ptj1":    read_hepdata(HEPDATA_DIR/"HEPData_WpJ_ptj1.csv"),
        "yj1": read_hepdata(HEPDATA_DIR/"HEPData_WpJ_abs_yj1.csv"),
        "abs_etaj1": read_hepdata(HEPDATA_DIR/"HEPData_WpJ_abs_etaj1.csv"),
        "ht_full": read_hepdata(HEPDATA_DIR/"HEPData_WpJ_HT.csv"),
        "ht_jets": read_hepdata(HEPDATA_DIR/"HEPData_WpJ_HTjets.csv"),
        "ptw":     read_hepdata(HEPDATA_DIR/"HEPData_WpJ_ptw.csv"),
    }
