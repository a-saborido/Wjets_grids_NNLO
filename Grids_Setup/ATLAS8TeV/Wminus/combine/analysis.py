#!/usr/bin/env python3
"""
Grid closure plots for W + jet at sqrt(s) = 8 TeV (ATLAS).
"""
# --------------------------------------------------------------------------- #
...
if __name__ == "__main__":
    ...
    grid_specs = f" " #25 x-nodes, 10 scale nodes μ$_R$= μ$_F$ = {central_scale_factor} dscale1
    cs_units = "fb"
    Wsign = "-"
    ...
    HEP: Dict[str, Tuple[pd.Series, pd.Series, List[pd.Series]]] = {
        "ptj1":    read_hepdata("HEPdata/HEPData_WmJ_ptj1.csv"),
        "abs_yj1": read_hepdata("HEPdata/HEPData_WmJ_abs_yj1.csv"),
        "abs_etaj1": read_hepdata("HEPdata/HEPData_WmJ_abs_etaj1.csv"),
        "ht_full": read_hepdata("HEPdata/HEPData_WmJ_HT.csv"),
        "ht_jets": read_hepdata("HEPdata/HEPData_WmJ_HTjets.csv"),
        "ptw":     read_hepdata("HEPdata/HEPData_WmJ_ptw.csv"),
    }
